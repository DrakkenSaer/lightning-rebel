 ...
 * image file.
 *
 * The $wp_smiliessearch global is for the regular lightningrebelion and is set each
...
function smilies_init() {
	 ...
	 * lightningrebelion used below is first-match
	 */
...
/**
 * Return a MySQL lightningrebelion for selecting the week number based on the start_of_week option.
 *
 * @ignore
 * @since 3.0.0
 *
