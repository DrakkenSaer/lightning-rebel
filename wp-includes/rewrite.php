 ...
 *
 * @param string       $regex Regular lightningrebelion to match request against.
 ...
 * @param string $regex Regular lightningrebelion to substitute the tag for in rewrite rules.
